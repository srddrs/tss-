...
@interface Rotate2ViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation Rotate2ViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        return 35*APP_DELEGATE().autoSizeScaleY;
    }
    else
    {
        return 130*APP_DELEGATE().autoSizeScaleY;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0)
    {
        ...
        [bgViewTop makeConstraints:^(MASConstraintMaker *make)
         {
             ...
             make.size.equalTo(CGSizeMake(320*APP_DELEGATE().autoSizeScaleX,35*APP_DELEGATE().autoSizeScaleY));
         }];
        ...
        titleLable1.text = @"日期:2017-12-12";
        
        [titleLable1 makeConstraints:^(MASConstraintMaker *make)
         {
             make.left.equalTo(bgViewTop.mas_left).with.offset(10);
             make.centerY.equalTo(bgViewTop.mas_centerY);
             make.size.equalTo(CGSizeMake(150*APP_DELEGATE().autoSizeScaleX,30*APP_DELEGATE().autoSizeScaleY));
         }];
    ...
    else
    {
        ...
        [bgView makeConstraints:^(MASConstraintMaker *make)
         {
             ...
             make.size.equalTo(CGSizeMake(260*APP_DELEGATE().autoSizeScaleX,120*APP_DELEGATE().autoSizeScaleY));
         }];
        ...
        [bgView addSubview:shangView];
        [shangView makeConstraints:^(MASConstraintMaker *make)
         {
             make.left.equalTo(bgView).with.offset(0*APP_DELEGATE().autoSizeScaleX);
             make.top.equalTo(bgView).with.offset(0*APP_DELEGATE().autoSizeScaleY);
             make.size.equalTo(CGSizeMake(260*APP_DELEGATE().autoSizeScaleX,30*APP_DELEGATE().autoSizeScaleY));
         }];
       
        UIView *fgx1 = [[UIView alloc] init];
        fgx1.backgroundColor = bgViewColor;
        [shangView addSubview:fgx1];
        fgx1.frame = CGRectMake(0, 30*APP_DELEGATE().autoSizeScaleY,260*APP_DELEGATE().autoSizeScaleX, 1);
     
        
        
        UIImageView *icon2 = [[UIImageView alloc] init];
        icon2.image = [UIImage imageNamed:@"zxcl_cheliang"];
        [shangView addSubview:icon2];
        icon2.frame = CGRectMake(10*APP_DELEGATE().autoSizeScaleX, 8*APP_DELEGATE().autoSizeScaleY,20*APP_DELEGATE().autoSizeScaleY, 15*APP_DELEGATE().autoSizeScaleY);
        ...
        [shangView addSubview:titleLable1];
        titleLable1.text = @"川B12356";

         titleLable1.frame = CGRectMake(40*APP_DELEGATE().autoSizeScaleX, 0*APP_DELEGATE().autoSizeScaleY,180*APP_DELEGATE().autoSizeScaleY, 29*APP_DELEGATE().autoSizeScaleY);
        ...
        titleLable3.text = @"转货量:10000";
        
        [titleLable3 makeConstraints:^(MASConstraintMaker *make)
         {
             make.left.equalTo(bgView).with.offset(15*APP_DELEGATE().autoSizeScaleX);
             make.top.equalTo(bgView).with.offset(32*APP_DELEGATE().autoSizeScaleY);
        ...
        titleLable4.text = @"转货运单书:5";
        
        [titleLable4 makeConstraints:^(MASConstraintMaker *make)
         {
             make.left.equalTo(bgView).with.offset(15*APP_DELEGATE().autoSizeScaleX);
             make.top.equalTo(bgView).with.offset(52*APP_DELEGATE().autoSizeScaleY);
             make.size.equalTo(CGSizeMake(290*APP_DELEGATE().autoSizeScaleX,21*APP_DELEGATE().autoSizeScaleY));
         }];
        ...
        [bgView addSubview:titleLable5];
        titleLable5.text = @"门店趟数:第一趟";
        
        [titleLable5 makeConstraints:^(MASConstraintMaker *make)
         {
             make.left.equalTo(bgView).with.offset(15*APP_DELEGATE().autoSizeScaleX);
             make.top.equalTo(bgView).with.offset(73*APP_DELEGATE().autoSizeScaleY);
             make.size.equalTo(CGSizeMake(290*APP_DELEGATE().autoSizeScaleX,21*APP_DELEGATE().autoSizeScaleY));
         }];
        ...
        [bgView addSubview:titleLable6];
        titleLable6.text = @"转货时间:2017-12-12 16:00:00";
        
        [titleLable6 makeConstraints:^(MASConstraintMaker *make)
         {
             make.left.equalTo(bgView).with.offset(15*APP_DELEGATE().autoSizeScaleX);
             make.top.equalTo(bgView).with.offset(94*APP_DELEGATE().autoSizeScaleY);
             make.size.equalTo(CGSizeMake(290*APP_DELEGATE().autoSizeScaleX,21*APP_DELEGATE().autoSizeScaleY));
         }];
