...
{
#if CGFLOAT_IS_DOUBLE
//    NSLog(@"11111:%f",round(CGRectGetWidth(self.rightUtilityButtonsView.frame) + self.additionalRightPadding));
    return round(CGRectGetWidth(self.rightUtilityButtonsView.frame) + self.additionalRightPadding);
#else
//    NSLog(@"2222:%f",roundf(CGRectGetWidth(self.rightUtilityButtonsView.frame) + self.additionalRightPadding));
